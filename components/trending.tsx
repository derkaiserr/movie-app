...
const Trending = () => {
  return (
    <div className="w-52 relative h-72 rounded-lg rounded ">
      <Image
        // fill={true}
        layout="fill"
        src="/images/trending-movie.png"
        objectFit="cover"
        alt="cover image"
        className="rounded-lg rounded-b-full"
      />
      <div className="w-full left-0 p-2 bottom-0 flex justify-between items-start bg-[#00000074] absolute ">
        <div className="w-[80%] ">
          <p>Tokyo Train</p>
          <p>
            <span>2022</span> | <span>Action</span>
          </p>
        </div>
        <svg
          width="24"
          ...
          className="right-2 bsolute bottom-0  "
        >
          <g opacity="0.8">
            <path
